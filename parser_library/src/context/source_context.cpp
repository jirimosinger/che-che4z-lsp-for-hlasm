...
source_context::source_context(utils::path::resource_location source_uri, processing::processing_kind initial)
    : current_instruction(position(), std::move(source_uri))
