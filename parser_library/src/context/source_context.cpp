...
source_context::source_context(utils::path::external_resource source_path, processing::processing_kind initial)
    : current_instruction(position(), std::move(source_path))
