    ...
    , ord_ctx(*ids_, *this)
{
    ...
    push_statement_processing(processing::processing_kind::ORDINARY, std::move(file_name.get_absolute_path())); // todo is it possible to have push_statement_processing accept external_resource?
}
