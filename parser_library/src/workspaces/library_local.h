...
public:
    ...
    library_local(file_manager& file_manager, utils::path::resource_location lib_uri, library_local_options options);
    ...
    const utils::path::resource_location& get_lib_uri() const;
...
private:
    ...
    utils::path::resource_location lib_uri_;
